...
(
    ...
    initctl stop tunnel_3770_code1
    initctl stop tunnel_3770_code2
    initctl stop tunnel_3770_code3
    initctl stop tunnel_3770_code4
    initctl stop tunnel_3770_code5
    rm /etc/init/tunnel_*
)  2> /dev/null
